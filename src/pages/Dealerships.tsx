      ...
      <div className="bg-gradient-to-r from-[#0038BC] via-[#0751C9] to-[#1769E0] text-white py-14 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center space-y-4">
          ...
          <p className="text-sm sm:text-base text-[#D9EAFF] max-w-2xl mx-auto">
            Explore verified car yards and licensed auto dealers across Nairobi, Mombasa, and Nakuru. Every listed dealer is logbook-audited and background-verified by YARDLY.
          </p>
        </div>
      </div>
