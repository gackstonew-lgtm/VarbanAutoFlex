        ...
        <div className="bg-white rounded-3xl border border-[#D9EAFF] p-6 sm:p-8 shadow-xl space-y-6">
          ...
          <div className="text-center space-y-3">
            ...
            <h2 className="text-2xl font-extrabold text-[#10233F]">
              {isRegister ? `Register as a ${registerRole === 'seller' ? 'Seller / Dealer' : 'Buyer'}` : 'Varban Partner & Buyer Sign In'}
            </h2>
            <p className="text-xs text-[#64748B]">
              {isRegister 
                ? 'Create your Varban Auto Flex account to buy, bid, list cars or request imports' 
