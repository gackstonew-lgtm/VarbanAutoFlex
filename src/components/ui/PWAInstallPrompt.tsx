      ...
      <div className="flex items-start justify-between gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            <h4 className="font-bold text-sm text-white">Install YARDLY App</h4>
          ...
          <p className="text-xs text-slate-300 mt-1 leading-relaxed">
            {isIOS 
              ? 'Install YARDLY on your iPhone: tap Share in Safari, then select "Add to Home Screen".'
              : 'Add YARDLY to your home screen for fast offline browsing and direct access.'}
          </p>
        </div>
